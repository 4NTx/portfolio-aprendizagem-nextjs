      ...
      <div>
        ...
        <div>
          <ul className={styles.navItems}>
            ...
            <li>
              <Link href="/contact">Projetos</Link>
            </li>
            <li>
        ...
        <div className={styles.redes}>
          <a
            rel="noreferrer"
            target="_blank"
            className="inline-block flex h-min w-min rounded-full p-2 transition-colors hover:bg-gray-800/20 dark:hover:bg-gray-400/20 leading-0 items-center"
            aria-label="Discord"
            href="https://discord.gg/4ntx"
          >
            <svg
