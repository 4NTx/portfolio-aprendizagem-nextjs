...
const Navbar: React.FC = () => {
  const copiarEmail = async () => {
    try {
      await navigator.clipboard.writeText("arturrrick@gmail.com");
      ...
      toast.error("Falha ao copiar o e-mail", {
        position: "bottom-center",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
  ...
  return (
    <nav className={styles.navbar}>
      <div className={styles.logo}>
        <Link href="/projetos">
          <Image src="/imagens/logo.svg" alt="Logo" width={120} height={100} />
        </Link>
      </div>
      ...
      <div className={styles.redesSociais}>
        <Link
          rel="noreferrer"
          className={styles.redesSociaisItems}
          aria-label="E-Mail"
          href="#"
          onClick={copiarEmail}
        >
          <svg
            ...
            viewBox="0 0 496 500"
            className={styles.redesSociaisSVG}
          >
